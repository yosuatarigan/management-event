class BAHarian {
  ...
  String status6, status7, status8, status9, status10, status11;
  String laptop;
  
  // Sarana Prasarana quantities (sama seperti BA Dismantle)
  ...
  BAHarian({
    ...
    required this.status1, required this.status2, required this.status3,
    required this.status4, required this.status6, required this.status7,
    required this.status8, required this.status9, required this.status10,
    required this.status11, required this.laptop,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'status4': status4, 'status6': status6, 'status7': status7,
      'status8': status8, 'status9': status9, 'status10': status10,
      'status11': status11, 'laptop': laptop,
  ...
  factory BAHarian.fromMap(String id, Map<String, dynamic> map) {
    return BAHarian(
      id: id,
      tilok: map['tilok'] ?? '',
      alamat: map['alamat'] ?? '',
      ...
      status1: map['status1'] ?? '', status2: map['status2'] ?? '',
      status3: map['status3'] ?? '', status4: map['status4'] ?? '',
      status6: map['status6'] ?? '', status7: map['status7'] ?? '',
      status8: map['status8'] ?? '', status9: map['status9'] ?? '',
      status10: map['status10'] ?? '', status11: map['status11'] ?? '',
      laptop: map['laptop'] ?? '',
