    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Card(
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                TextField(controller: eventNameC, decoration: const InputDecoration(labelText: 'Nama Acara')),
                const SizedBox(height: 8),
                FilledButton(
                  onPressed: () async {
          ...
          Card(
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const SizedBox(height: 8),
                TextField(controller: locNameC, decoration: const InputDecoration(labelText: 'Nama Lokasi')),
                const SizedBox(height: 8),
                TextField(controller: locAddressC, decoration: const InputDecoration(labelText: 'Alamat (opsional)')),
                const SizedBox(height: 8),
                FilledButton(
                  onPressed: () async {
          ...
          const SizedBox(height: 16),
          Text('Manajemen User & Role', style: Theme.of(context).textTheme.titleLarge),
          const SizedBox(height: 12),
          Card(
            child: StreamBuilder(
                  ...
                  children: docs.map((d) {
                    ...
                    return ListTile(
                      ...
                      trailing: DropdownButton<String>(
                        ...
                        onChanged: (val) async {
                          if (val != null) await AuthService.updateRole(d.id, val);
                        },
                      ),
                    );
                  }).toList(),
